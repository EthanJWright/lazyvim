...
local function roll_name()
  math.randomseed(os.time())
  return left[math.random(#left)] .. "_" .. right[math.random(#right)]
end

local function random_name()
  local name = roll_name()
  -- per tradition, can't have boring_wozniak!
  while name == "boring_wozniak" do
    name = roll_name()
  end
